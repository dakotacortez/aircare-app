...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "protocols" (
        ...
        "category" "enum_protocols_category" NOT NULL,
        ...
        "last_reviewed" timestamp(3) with time zone NOT NULL,
        "next_review" timestamp(3) with time zone NOT NULL,
  ...
  CREATE TABLE "_protocols_v" (
        ...
        "version_content_bls" jsonb,
        "version_content_als" jsonb,
        "version_content_cct" jsonb,
  ...
  CREATE INDEX "_protocols_v_version__order_idx" ON "_protocols_v" USING btree ("version__order");
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  DROP INDEX IF EXISTS "_protocols_v_version__order_idx";
