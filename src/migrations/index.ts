...
import * as migration_20251122_230000_fallback_fix_push_notifications_ids from './20251122_230000_fallback_fix_push_notifications_ids';

export const migrations = [
  {
    up: migration_20250214_000000_protocols.up,
    down: migration_20250214_000000_protocols.down,
    name: '20250214_000000_protocols',
  },
  {
  ...
  {
    up: migration_20251121_200000_force_fix_parent_id_columns.up,
    down: migration_20251121_200000_force_fix_parent_id_columns.down,
    name: '20251121_200000_force_fix_parent_id_columns',
  },
  {
    up: migration_20251121_210000_ensure_push_notifications_target_roles_table.up,
    down: migration_20251121_210000_ensure_push_notifications_target_roles_table.down,
    name: '20251121_210000_ensure_push_notifications_target_roles_table',
  },
  {
    up: migration_20251121_220000_add_notification_cols_to_locked_docs_rels.up,
    down: migration_20251121_220000_add_notification_cols_to_locked_docs_rels.down,
    name: '20251121_220000_add_notification_cols_to_locked_docs_rels',
  },
  {
    up: migration_20251121_230000_add_default_id_to_target_roles.up,
    down: migration_20251121_230000_add_default_id_to_target_roles.down,
    name: '20251121_230000_add_default_id_to_target_roles',
  },
  {
    up: migration_20251122_003000_add_created_by_to_notifications.up,
    down: migration_20251122_003000_add_created_by_to_notifications.down,
    name: '20251122_003000_add_created_by_to_notifications',
  },
  {
  ...
  {
    up: migration_20251122_150000_overhaul_protocols_add_medications_v3.up,
    down: migration_20251122_150000_overhaul_protocols_add_medications_v3.down,
    name: '20251122_150000_overhaul_protocols_add_medications_v3',
  },
  {
  ...
  {
    up: migration_20251122_190000_add_protocol_defaults_global.up,
    down: migration_20251122_190000_add_protocol_defaults_global.down,
    name: '20251122_190000_add_protocol_defaults_global',
  },
  {
    up: migration_20251122_203500_fix_protocol_defaults_tables.up,
    down: migration_20251122_203500_fix_protocol_defaults_tables.down,
    name: '20251122_203500_fix_protocol_defaults_tables',
  },
  {
    up: migration_20251122_230000_fallback_fix_push_notifications_ids.up,
    down: migration_20251122_230000_fallback_fix_push_notifications_ids.down,
    name: '20251122_230000_fallback_fix_push_notifications_ids',
  },
];
